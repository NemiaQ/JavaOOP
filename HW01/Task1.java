...
public class Task1 {
    public static void main(String[] args) {
        Product[] products = new Product[]{
                new Milk("МолПрод", 56, 1, "уп.", 1, 3.6, 7),
                new Lemonade("Черноголовка", 90, 2, "бут.", 1.5),
                new Bread("Батон нарезной", 33, 15, "уп.", 4, "Пшеничная хлебопекарная"),
                new Egg("Крепыши", 90, 3, "уп.", 10),
                new Mask("Идеал", 545, 2, "уп.", 1),
                new ToiletPaper("Перышко", 80, 10, "шт.", 4, 2),
                new Diaper("Памперсы", 1300, 60, "уп.",0, true, "S", 1, 4, "одноразовые"),
                new Nipple("Солнышко", 150, 4, "уп.", 1, false)
        };
